            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="username" class="form-control" id="yourUsername" value="admin@gmail.com" required>
                  ...
                  <a href="<%= request.getContextPath() %>/pages/dashboard.jsp"><button class="btn btn-primary w-100" type="submit">index</button></a>
                </div>
              </div>
