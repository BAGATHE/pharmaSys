            ...
            <div class="offset-md-2 col-md-8">
              ...
              <div class="card">
                <div class="card-header" style="background-color: #1b1d38;">
                    <a href="<%= request.getContextPath() %>/pages/reductions/liste.jsp"><button type="button" class="btn btn-info">retour</button></a>
                  <div class="card-title"><h2 class="text-center" style="color: white;">mise a jour Reduction</h2></div>
                </div>
                <div class="card-body">
                  <div class="row">
