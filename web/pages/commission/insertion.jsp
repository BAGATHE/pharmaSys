    ...
    <div class="container">
        <div class="page-inner">
          <div class="page-header">
            <h3 class="fw-bold mb-3">Commission/h3>
            ...
            <div class="offset-md-2 col-md-8">
              ...
              <div class="card">
                <div class="card-header" style="background-color: #1b1d38;">
                  <div class="card-title"><h2 class="text-center" style="color: white;">Insertion Commission</h2></div>
                </div>
                <div class="card-body">
                  <div class="row">
                    <div class="offset-md-3 col-md-6 offset-lg-2 col-lg-8">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="number" name="pourcentage" id="pourcentage" required min="0">
                    </div>
                        <div class="row">
