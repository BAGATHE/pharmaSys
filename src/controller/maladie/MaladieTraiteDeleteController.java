...
@WebServlet("/maladies/maladieTraiteDelete")
public class MaladieTraiteDeleteController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            TraitementRepository.deleteByMaladieAndMedicament(connection, idMaladie, idMedicament);
            connection.commit();
