...
@WebServlet("/achat/laboratoire")
public class AchatLaboratoireController extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection connection = Connexion.connect()) {
            ...
            RequestDispatcher dispatcher = request.getRequestDispatcher("/pages/achats/liste_fournisseur.jsp");
