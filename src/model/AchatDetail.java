...
public class AchatDetail {
    ...
    public AchatDetail(String idAchatDetail, String idAchat, Medicament medicament, int quantite, double prixAchat,
            Unite unite) {
    ...
    public boolean estPossible(Laboratoire laboratoire) {
        return true;
    }
}
