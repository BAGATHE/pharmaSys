...
public class MouvementStockDetail {
    ...
    public MouvementStockDetail(String idMouvementStockDetail, String idMouvementStock, double entree, double sortie,
            double prixUnitaire, Unite unite, Medicament medicament) {
    ...
    public MouvementStockDetail() {
        this.setIdMouvementStockDetail("");
    }
}
